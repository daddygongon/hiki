...
//cc by Takuma Tsujikawa,2016
//引用元　http://www.openprocessing.org/sketch/100539
class ChrBall { 
...
void draw() { 
  ...
  //以下コーナーモード{ 
    ...
    if(EffectMd == 0) Effect(color(#FAEDFF)); 
